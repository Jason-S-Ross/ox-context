...
*** Footnote Reference
#+INCLUDE: ./examples/footnotes.org
*** Smart Quotes
...
*** Citations
#+INCLUDE: ./examples/citations.org
    
** Paragraph Elements
These elements form their own paragraph or section in the export.
*** Tables
#+INCLUDE: ./examples/tables.org

*** Images
#+INCLUDE: ./examples/images.org

*** Headlines
#+INCLUDE: ./examples/headlines.org
*** Equations
#+INCLUDE: ./examples/equations.org
